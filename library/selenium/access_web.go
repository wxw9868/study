...
func AccessWeb() {
	...
	opts := []selenium.ServiceOption{
		...
		selenium.ChromeDriver(chromePath), // Specify the path to GeckoDriver in order to use Firefox.
		//selenium.Output(os.Stderr),        // Output debug information to STDERR.
	}
	selenium.SetDebug(true)

	service, err := selenium.NewChromeDriverService(chromePath, port, opts...)
	if nil != err {
